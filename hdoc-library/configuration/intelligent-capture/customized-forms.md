...
* **Custom Form Name**: The display name for the node on the intelligent capture designer.
...
* **Show this field in summary panel once form is completed**: Tick this option if you want the question and answer to appear on the right hand side confirmation panel during the Intelligent Capture flow.
...
* **This field will be visible in read mode if it has no value**: Tick this option if you would like this field to be displayed, even if there is no value stored in it. Just the label will be shown.
...
* Add a new form field to a capture form and unselect the `This field will be visible on the form` option under the Default Flags tab
